...
class Network(models.Model):
    ...
    explorer_url = models.CharField(max_length=STRING_LENGTH * 10, default="", blank=True, help_text="Provide root URL of explorer with no trailing slash. Example: 'https://etherscan.io'")
